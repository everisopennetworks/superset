...
const ActionTableStyles = styled.div`
...
const ActionTable = ({
  ...
  return (
    <ActionTableStyles className={`action-table ${className}`} height={height}>
      <TableView
...
ActionTable.defaultProps = defaultProps;
