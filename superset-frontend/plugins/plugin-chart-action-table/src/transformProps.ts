...
import { DataColumnMeta, ActionTableChartProps, ActionTableChartTransformedProps } from './types';
...
const processColumns = memoizeOne(function processColumns(props: ActionTableChartProps) {
  const {
...
const transformProps = (chartProps: ActionTableChartProps): ActionTableChartTransformedProps => {
  const {
    height,
    width,
