...
import { ActionTableChartFormData } from './types';
 ...
 */
export function getQueryMode(formData: ActionTableChartFormData) {
...
const buildQuery: BuildQuery<ActionTableChartFormData> = (formData: ActionTableChartFormData, options) => {
...
export const cachedBuildQuery = (): BuildQuery<ActionTableChartFormData> => {
