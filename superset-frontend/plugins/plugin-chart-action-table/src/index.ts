...
import { ActionTableChartFormData, ActionTableChartProps } from './types';
...
export default class ActionTableChartPlugin extends ChartPlugin<ActionTableChartFormData, ActionTableChartProps> {
  constructor() {
    super({
      loadChart: () => import('./ActionTableChart'),
      metadata,
      transformProps,
      controlPanel,
      buildQuery,
