...
const transformProps = chartProps => {
  ...
  const timeGrain = (0, _core.extractTimegrain)(formData);
  ...
  const columnColorFormatters = (_getColorFormatters = (0, _chartControls.getColorFormatters)(conditionalFormatting, data)) != null ? _getColorFormatters : [];
  return {
    height,
    width,
