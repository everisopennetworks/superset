...
exports.default = AlarmTableChart;
...
var _TicketManager = require("./utils/TicketManager");
...
function ModalCreateTicket({
  ...
  const handleOk = (0, _react.useCallback)(values => {
    setLoading(true);

    _TicketManager.ticketManager.createTicket({ ...values.ticket,
      alarms
    });
  ...
  return (0, _react2.jsx)(_antd.Modal, {
    title: "Create new ticket",
    visible: show,
    onCancel: handleCancel,
    footer: [(0, _react2.jsx)(_antd.Button, {
      style: {
        marginRight: 10
      },
      disabled: loading,
      ...
      htmlType: "submit",
      form: "create-ticket"
    }, "Create"), (0, _react2.jsx)(_antd.Button, {
      type: "default",
      onClick: handleCancel
    }, "Cancel")]
  }, (0, _react2.jsx)(_antd.Form, {
    form: form,
    name: "create-ticket",
    onFinish: handleOk,
    validateMessages: validateMessages
  }, (0, _react2.jsx)(_antd.Form.Item, {
    name: ['ticket', 'shortDescription'],
    label: "Short description",
    rules: [{
      required: true
    }]
  }, (0, _react2.jsx)(_antd.Input, null)), (0, _react2.jsx)(_antd.Form.Item, {
    name: ['ticket', 'impact'],
    label: "Impact",
    rules: [{
      required: true
    }]
  }, (0, _react2.jsx)(_antd.Select, null, (0, _react2.jsx)(_antd.Select.Option, {
    value: 1
  }, "High"), (0, _react2.jsx)(_antd.Select.Option, {
    value: 2
  }, "Mid"), (0, _react2.jsx)(_antd.Select.Option, {
    value: 3
  }, "Low"))), (0, _react2.jsx)(_antd.Form.Item, {
    name: ['ticket', 'urgency'],
    label: "Urgency",
    rules: [{
      required: true
    ...
    value: 3
  }, "Low"))), (0, _react2.jsx)(_antd.Form.Item, null, (0, _react2.jsx)(_antd.List, {
    header: (0, _react2.jsx)("div", null, "Description:"),
    bordered: true,
    dataSource: alarms,
    renderItem: item => (0, _react2.jsx)(_antd.List.Item, {
      key: item.ALARMID
    }, (0, _react2.jsx)(_antd.Typography.Text, {
      mark: true
    }, `${item.ALARMEDOBJECTNAME} ${item.ALARMTYPEID} ${item.SPECIFICPROBLEM}`))
  }))));
}

function AlarmTableChart(props) {
  const {
    timeGrain,
    height,
    width,
  ...
  if (columnsMeta[0].key !== 'item_select') {
    columnsMeta.unshift({
      config: {},
      dataType: 1,
      key: 'item_select',
  ...
  const [selectedAlarms, setSelectedAlarms] = (0, _react.useState)({});
  const [showModal, setShowModal] = (0, _react.useState)(false);

  const handleOnItemSelect = (alarm, checked) => {
    setSelectedAlarms({ ...selectedAlarms,
      [alarm.ALARMID]: checked ? alarm : null
    });
  };
  ...
  const getColumnConfigs = (0, _react.useCallback)((column, i) => {
    ...
    return {
      ...
      Cell: ({
        ...
        if (key === 'item_select') {
          return (0, _react2.jsx)("td", cellProps, (0, _react2.jsx)(_antd.Checkbox, {
            onChange: e => handleOnItemSelect(row.original, e.target.checked),
            checked: selectedAlarms[row.original.ALARMID]
          }));
  ...
  }, [defaultAlignPN, defaultColorPN, emitFilter, getValueRange, isActiveFilterValue, isRawRecords, showCellBars, sortDesc, toggleFilter, totals, columnColorFormatters, selectedAlarms]);
  ...
  const handleOnCreateTicked = (0, _react.useCallback)(() => {
    setShowModal(true);
  }, [selectedAlarms]);
  const handleOnClose = (0, _react.useCallback)(success => {
    if (success) {
      setSelectedAlarms([]);
    }

    setShowModal(false);
  }, [setSelectedAlarms, setShowModal]);
  return (0, _react2.jsx)(_Styles.default, null, (0, _react2.jsx)("div", {
    style: {
      display: 'flex',
      flexDirection: 'row',
      justifyContent: 'end',
  ...
  }, (0, _react2.jsx)(_antd.Button, {
    onClick: handleOnCreateTicked,
    style: {
      marginRight: 5
    },
    type: "primary",
    disabled: Object.values(selectedAlarms).filter(a => a !== null).length === 0
  }, "Create Ticket")), (0, _react2.jsx)(_DataTable.default, {
    columns: columns,
    data: data,
    rowCount: rowCount,
    ...
    ,
    sticky: sticky
  }), showModal && (0, _react2.jsx)(ModalCreateTicket, {
    onClose: handleOnClose,
    show: showModal,
    alarms: Object.values(selectedAlarms).filter(a => a !== null)
  }));
}