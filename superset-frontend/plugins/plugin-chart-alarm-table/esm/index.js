...
const metadata = new ChartMetadata({
  ...
  name: t('AlarmTable'),
  tags: [t('Additive'), t('Business'), t('Formattable'), t('Pattern'), t('Popular'), t('Report'), t('Sequential'), t('Tabular'), t('Description')],
  thumbnail
});
export default class AlarmTableChartPlugin extends ChartPlugin {
  constructor() {
    super({
      loadChart: () => import('./AlarmTableChart'),
      metadata,
      transformProps,
      controlPanel,
      buildQuery
