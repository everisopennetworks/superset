...
import AlarmTableChart from '../src/AlarmTableChart';
...
describe('plugin-chart-table', () => {
  ...
  describe('AlarmTableChart', () => {
    let wrap: CommonWrapper; // the ReactDataTable wraper
    let tree: Cheerio;

    it('render basic data', () => {
      wrap = mount(<AlarmTableChart {...transformProps(testData.basic)} sticky={false} />);
    ...
    it('render advanced data', () => {
      wrap = mount(<AlarmTableChart {...transformProps(testData.advanced)} sticky={false} />);
      tree = wrap.render();
